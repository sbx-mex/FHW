const CACHE = "fhw-v1";
const CORE = ["/", "/manifest.webmanifest", "/data/fhw-dashboard.json", "/data/juntemonos-mas.json", "/assets/logo-cada-taza-cuenta.png", "/assets/fondo-dashboard-fhw.png", "/assets/juntemonos-mas.png", "/Toolkit_Cada_Taza_Cuenta.pdf"];
